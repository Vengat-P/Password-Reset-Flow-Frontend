    ...
    <div className="container vh-100 mw-100 d-flex justify-content-center align-content-center   border border-2 bg-primary-subtle ">
      ...
      <form onSubmit={handleSubmit} className=" container d-grid justify-content-center">
        ...
        <p className="d-flex flex-column ">
          ...
          />
          <button type="button" className="border-0 bg-white" onClick={() => setShowPassword(!showPassword)}>
            {showPassword ? (
            <svg
          ...
          <br />
          <button type="submit" className="d-flex m-2 p-2 rounded-2 border border-1 shadow-sm bg-success text-white justify-content-center">Register</button>
